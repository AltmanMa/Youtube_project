...
X_train = data[["likes"]].to_numpy()
Y_train = data["views"].to_numpy()
X_test = data[["likes"]].to_numpy()
Y_test = data["views"].to_numpy()
...
#=========================几个Follow up steps=============================
#1.回答问题：为什么MSE这么大？如何避免MSE过大？
#2.采用random forest 和 XGboost 实现一遍上述过程，并比较模型结果。
