...
# 预处理文本数据
processed_docs = df['title'].apply(preprocess_text).astype(str)
processed_docs = df['channel_title'].apply(preprocess_text).astype(str) + processed_docs
processed_docs = df['tags'].apply(preprocess_text).astype(str) + processed_docs
